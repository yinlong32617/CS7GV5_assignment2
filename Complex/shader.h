...
public:
	...
	{
		glUniform2fv(glGetUniformLocation(ID, name.c_str()), 1, value.v);
	}
	...
	{
		glUniform3fv(glGetUniformLocation(ID, name.c_str()), 1, value.v);
	}
	...
	{
		glUniform4fv(glGetUniformLocation(ID, name.c_str()), 1, value.v);
	}
	...
	{
		glUniformMatrix3fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, mat.m);
	}
	// ------------------------------------------------------------------------
